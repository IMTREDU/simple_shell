...
/**
 * initializeInfo - Initializes the Commandinfo_t struct
...
/**
 * configureInfo - Configures the Commandinfo_t struct
 * @info: Address of the struct
...
/**
 * releaseInfo - Releases resources associated with the Commandinfo_t
 * @info: Address of the struct
